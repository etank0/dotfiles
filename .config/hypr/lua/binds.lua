...
hl.bind(
  vars.mainMod .. " + W",
  hl.dsp.exec_cmd(vars.scripts .. "/toggle-waybar.sh")
)
hl.bind(
  vars.mainMod .. " + SHIFT + W",
  hl.dsp.exec_cmd(vars.scripts .. "/hyprwalchange.sh")
)
hl.bind(
  vars.mainMod .. " + ALT + R",
  hl.dsp.exec_cmd(vars.scripts .. "/refresh.sh")
)
hl.bind(
  vars.mainMod .. " + SHIFT + C",
  hl.dsp.exec_cmd(vars.scripts .. "/clip-manager.sh")
)
hl.bind(
  vars.mainMod .. " + SHIFT + E",
  hl.dsp.exec_cmd(vars.scripts .. "/emoji-picker.sh")
)
hl.bind(vars.mainMod .. " + E", hl.dsp.exec_cmd(vars.fileManager))

-- Audio & Media
hl.bind(
  vars.mainMod .. " + bracketleft",
  hl.dsp.exec_cmd(vars.scripts .. "/volume-control.sh --dec")
)
hl.bind(
  vars.mainMod .. " + bracketright",
  hl.dsp.exec_cmd(vars.scripts .. "/volume-control.sh --inc")
)
hl.bind(
  vars.mainMod .. " + backslash",
  hl.dsp.exec_cmd(vars.scripts .. "/volume-control.sh --toggle")
)
hl.bind(
  vars.mainMod .. " + apostrophe",
  hl.dsp.exec_cmd(vars.scripts .. "/volume-control.sh --toggle-mic")
)
hl.bind(
  vars.mainMod .. " + SHIFT + bracketleft",
  hl.dsp.exec_cmd(vars.scripts .. "/media-control.sh --prv")
)
hl.bind(
  vars.mainMod .. " + SHIFT + bracketright",
  hl.dsp.exec_cmd(vars.scripts .. "/media-control.sh --nxt")
)
hl.bind(
  vars.mainMod .. " + SHIFT + backslash",
  hl.dsp.exec_cmd(vars.scripts .. "/media-control.sh --pause")
)
...
hl.bind(
  vars.mainMod .. " + Z",
  hl.dsp.exec_cmd(vars.scripts .. "/magnifier.sh toggle")
)
hl.bind(
  vars.mainMod .. " + SHIFT + Z",
  hl.dsp.exec_cmd(vars.scripts .. "/magnifier.sh zoom-in")
)
hl.bind(
  vars.mainMod .. " + ALT + Z",
  hl.dsp.exec_cmd(vars.scripts .. "/magnifier.sh zoom-out")
)
...
hl.bind(
  vars.mainMod .. " + SHIFT + 9",
  hl.dsp.exec_cmd(vars.scripts .. "/brightness.sh --dec")
)
hl.bind(
  vars.mainMod .. " + SHIFT + 0",
  hl.dsp.exec_cmd(vars.scripts .. "/brightness.sh --inc")
)
hl.bind(
  vars.mainMod .. " + SHIFT + minus",
  hl.dsp.exec_cmd(vars.scripts .. "/brightness.sh --dec")
)
hl.bind(
  vars.mainMod .. " + SHIFT + equal",
  hl.dsp.exec_cmd(vars.scripts .. "/brightness.sh --inc")
)
...
-- Rofi Window
hl.bind(vars.mainMod .. " + A", hl.dsp.exec_cmd("rofi -show window"))
