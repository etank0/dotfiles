...
vim.keymap.set({ "n", "v" }, "<leader>ff",
    function() vscode.action("find-it-faster.findFiles") end)

-- Live Grep
-- vim.keymap.set({'n', 'v'}, "<leader>fg",
--     function() vscode.action('workbench.action.findInFiles') end);
vim.keymap.set({ "n", "v" }, "<leader>fg",
    function() vscode.action("find-it-faster.findWithinFiles") end)

-- Find Open Buffers
vim.keymap.set({ "n", "v" }, "<leader>fb",
    function() vscode.action("workbench.action.showAllEditorsByMostRecentlyUsed") end)
...
vim.keymap.set("n", "<leader>m",
    function() vscode.action("editor.emmet.action.matchTag") end)
...
vim.keymap.set("n", "<leader>tb",
    function() vscode.action("gitlens.toggleLineBlame") end)
...
vim.keymap.set("n", "<leader>=",
    function() vscode.action("workbench.action.evenEditorWidths") end)
vim.keymap.set("n", "<leader>-",
    function() vscode.action("workbench.action.toggleEditorWidths") end)
